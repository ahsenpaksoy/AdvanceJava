    ...
    public synchronized void withdraw(int amount){
        ...
        if (balance==0 || balance<amount){
            ...
            try {
                ...
                System.out.println("Bakiye guncellendi...");
            }
    ...
    public static void main(String[] args) {
        ...
        Thread thread2=new Thread(new Runnable() {
            ...
            public void run() {
                ...
                obj.deposit(2000);
                thread1.interrupt(); //cagirdigimiz threadi tamamen durdurmaz kesintiye ugratir
                //cagirdigimiz thread wait,sleep,join ile beklemekteyse exception firlatir
                //bu durum islemi surdurmek icin kullanilir
